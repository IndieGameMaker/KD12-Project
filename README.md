...
|---|---|---|---|---|---|
|1|Guest|Checkout|VR|서현지|서현지, 길재환, 이주영|
|2|미정|Tune(가칭)|VR|김석우|장세림, 김석우, 김민지|
|3|미정|AR 사고력(가칭)|AR|이재민|이재민,이유나, 추성결|
|4|미정|수화 RPG(가칭)|VR|이주성|이주성, 이유성, 장민욱, 권영진|
|5|미정|Miro(가칭)|VR|김승환|김승환, 홍지원, 신하은, 이건|
|6|미정|메디치의 눈물|VR|구관우|구관우, 강태훈, 현민기, 강효준|
|7|미정|미정|VR|김영서|김영서|
